...
function App() {
  ...
  return (
    <>
      <BrowserRouter>
        <Navbar isLogged={isLogged} isAuthenticated={isAuthenticated} handleLoginOut={handleLoginOut}   />
        <div className="container">
          <Routes>
            <Route path="register" element={<Register isLogged={isLogged}  setIsLogged={setIsLogged}/>} />
            <Route path="login" element={<Login isLogged={isLogged} onLogin={handleLogin} setIsLogged={setIsLogged} />} />
